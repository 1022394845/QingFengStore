		...
		>
			...
			<view class="navbar-right pointer">
				...
				<view
					v-if="logs.length"
					@click="showErrorLogs"
					class="menu-item debug pointer navbar-right-item-gap"
				>
					<svg class="svg-icon">
				...
				<view class="" style="position: relative">
					<view
						v-show="userInfo.nickname || userInfo.username || userInfo.mobile || userInfo.email"
						class="navbar-user"
					...
					<view class="navbar-menu">
						<template
							v-if="userInfo.nickname || userInfo.username || userInfo.mobile || userInfo.email"
						>
							...
							<view class="menu-item hover-highlight">
								<text class="logout pointer" @click="logout">
									{{ $t('topwindow.text.signOut') }}
								</text>
							</view>
						</template>
