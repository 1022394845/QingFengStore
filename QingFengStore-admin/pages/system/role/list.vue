				...
				>
					<uni-tr>
						<uni-th
							align="center"
							filter-type="search"
							@filter-change="filterChange($event, 'role_id')"
							sortable
							@sort-change="sortChange($event, 'role_id')"
						>
							唯一ID
						</uni-th>
						<uni-th
							align="center"
							filter-type="search"
							@filter-change="filterChange($event, 'role_name')"
							sortable
							@sort-change="sortChange($event, 'role_name')"
						>
							名称
						</uni-th>
						...
						<uni-th
							align="center"
							filter-type="search"
							@filter-change="filterChange($event, 'comment')"
							sortable
							@sort-change="sortChange($event, 'comment')"
						>
							备注
						</uni-th>
						<uni-th
					...
					<uni-tr v-for="(item, index) in data" :key="index">
						...
						<uni-td align="center">
							<view class="uni-group">
								...
								<button @click="confirmDelete(item._id)" class="uni-button" size="mini" type="warn">
		...
		return {
			collectionList: [
				db
					...
					.field('comment,permission,role_id,role_name,create_date')
					.getTemp(),
