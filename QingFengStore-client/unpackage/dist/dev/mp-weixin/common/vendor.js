...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__A33BDC8",
    appName: "QingFengStore-client",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initRuntimeSocketService() {
  const hosts = "26.93.98.154,192.168.137.1,192.168.40.4,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_Y57rVz";
  ...
  list: [
    {
      ...
      iconPath: "/static/icon/tab_ico_home.png",
      selectedIconPath: "/static/icon/tab_ico_home_a.png"
    },
    {
      text: "商城",
      pagePath: "pages/shop/category",
      iconPath: "/static/icon/tab_ico_shop.png",
      selectedIconPath: "/static/icon/tab_ico_shop_a.png"
    },
    {
      text: "资讯",
      pagePath: "pages/news/news",
      iconPath: "/static/icon/tab_ico_news.png",
      selectedIconPath: "/static/icon/tab_ico_news_a.png"
    },
    {
      text: "我的",
      pagePath: "pages/user/user",
      iconPath: "/static/icon/tab_ico_self.png",
      selectedIconPath: "/static/icon/tab_ico_self_a.png"
    }
  ]
};
const uniIdRouter = {};
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","26.93.98.154","192.168.137.1","192.168.40.4"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","D:/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"alipay","spaceName":"zfb-space","spaceId":"env-00jxtt1yph9m","spaceAppId":"2021005176605095","accessKey":"ZABCwZGGjdlr3x58","secretKey":"zIWDFGrkTXP0Q9Or"}]') || [];
let N = "";
try {
  N = "__UNI__A33BDC8";
} catch (e2) {
